...
## This is replementation of LightGCN using DL framework [PaddlePaddle](https://github.com/PaddlePaddle/Paddle).


### This repo is modified based on original [pytorch version](https://github.com/gusye1234/LightGCN-PyTorch).
